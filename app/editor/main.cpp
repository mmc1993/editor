...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(512, 256, "Dear ImGui GLFW+OpenGL3 example", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    //    { -14.5263062, -81.8362427 },
    //    { -35.0977783, -122.979095 },
    //    { -105.954895, -78.4077148 },
    //    { -105.383484, -28.1219482 },
    //    { -148.240601, 18.1637878 },
    //    { -130.526306, 106.163818 },
    //    { -120.812012, 15.8780823 },
    //    { -81.3834839, -24.1219177 },
    //    { -38.5263062, 4.44949341 },
    //    { 5.47369385,  70.7352295},
    //    { -72.8120117, 121.020966 },
    //    { 30.6165771,  87.8781128},
    //    { 0.000000000, 30.0000000},
    //};

    //tools::StripConvexPoints(points);
